...
/*
let middleware = applyMiddleware(thunk) // Other middlewares goes here
let enhancers = compse(middleware, window.__REDUX_DEVTOOLS_EXTENSION__ ? window.__REDUX_DEVTOOLS_EXTENSION__() : f => f) // for Dev tools
*/
